export const dinosaurDatabase = [
  ...
  {id: 'deinonychus', name: 'Deinonychus', type: 'carnivore', currency: 'Razor Talons', basePrice: 3200, price: 3200, weight: 75, rarity: 'Uncommon', abilities: 'Pounce → bleeding, can pin smaller dinosaurs'},
